...
class PromotionDraftListAdapter  (private var arrayList: List<PromotionListResult>, private val context: Context) :
    RecyclerView.Adapter<PromotionDraftListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.offer_price_txt.append(wordTwo)
        ...
        holder.itemView.final_price_txt.append(wordTwo2)
        ...
        holder.itemView.original_price_txt.append(wordTwo3)
